...
namespace Fastnet.Music.TagLib.Id3v2
{
    ...
    ///    writing ID3v2 tags.
    /// </summary>
    //public class Tag : TagLib.Tag, IEnumerable<Frame>, ICloneable - by asim to make this class partial, so I can add my own stuff in another file
    public partial class Tag : TagLib.Tag, IEnumerable<Frame>, ICloneable
    {
        ...
        /*private*/
        internal string GetUserTextAsString(string description, bool caseSensitive)
        {
        ...
        /// <returns>UserTextInformationFrame (TXXX) that corresponds to the description</returns>
        /*private*/
        internal string GetUserTextAsString(string description)
        {
