...
using Fastnet.Music.TagLib.IFD;
using Fastnet.Music.TagLib.IFD.Entries;
using Fastnet.Music.TagLib.IFD.Tags;
//using TagLib.Image;
//using TagLib.IFD;
//using TagLib.IFD.Entries;
//using TagLib.IFD.Tags;
//using TagLib.Xmp;
using Fastnet.Music.TagLib.Image;
using Fastnet.Music.TagLib.Xmp;
using System;

namespace Fastnet.Music.TagLib.Tiff
{
    /// <summary>
