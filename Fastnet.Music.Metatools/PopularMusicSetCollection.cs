...
namespace Fastnet.Music.Metatools
{
    ...
    /// grouped into a 'singles' album; (2) if it is a Collection folder then music files are grouped by artist into 'singles' folders;
    ...
    {
        public PopularMusicSetCollection(MusicOptions musicOptions, EntityHelper entityHelper,
    ...
    public class HindiFilmsMusicSetCollection : BaseMusicSetCollection<HindiFilmsAlbumSet>
    {
        public HindiFilmsMusicSetCollection(MusicOptions musicOptions, EntityHelper entityHelper, WorkFolder musicFolder, List<MusicFile> files, TaskItem taskItem) : base(musicOptions, entityHelper, musicFolder, files, taskItem)
        {
        }
