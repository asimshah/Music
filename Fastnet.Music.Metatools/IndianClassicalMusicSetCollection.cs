...
namespace Fastnet.Music.Metatools
{
    public class IndianClassicalMusicSetCollection : BaseMusicSetCollection<IndianClassicalAlbumSet, IndianClassicalRagaSet> //<IndianClassicalMusicTags>
    {
        ...
        public IndianClassicalMusicSetCollection(MusicOptions musicOptions, /*IndianClassicalInformation ici,*/ EntityHelper entityHelper, WorkFolder musicFolder, List<MusicFile> files, TaskItem taskItem)
        ...
        {
            return new IndianClassicalRagaSet(entityHelper, musicOptions, /*ici,*/ files, taskItem);
        }
