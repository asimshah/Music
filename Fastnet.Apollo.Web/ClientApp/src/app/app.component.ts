...
export class AppComponent {
   @ViewChild(DialogTestComponent, { static: false }) dialogTest: DialogTestComponent;
   ...
   constructor(private ls: LibraryService,
      ...
      //PopupDialogComponent.dialogStack.push(thisApp.nativeElement);
      this.ps.ready$.subscribe(async (v) => {
         if (v === true) {
            ...
            this.log.information(`[AppComponent] version ${appInfo.version.toString()}, ${this.parameters.clientIPAddress} [key: ${this.parameters.browserKey}], isMobile = ${this.isMobileDevice()}, isIpad = ${this.isIpad()}`);
