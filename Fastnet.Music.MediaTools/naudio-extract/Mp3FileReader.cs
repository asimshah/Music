...
namespace NAudio.Wave
{
    ...
    {
        private int minimumBitRate = int.MaxValue;
        ...
        private readonly bool validateFrames;
        /// <summary>Supports opening a MP3 file</summary>
        public Mp3FileReader(string mp3FileName, bool validateFrames = true)
            ...
            try
            {
                ...
                do
                {
                    ...
                    if (frame != null)
                    {
                        ...
                        if (frame.BitRate < minimumBitRate)
                        {
                            minimumBitRate = frame.BitRate;
                        }
                        if (frame.BitRate > maximumBitRate)
                        {
                            maximumBitRate = frame.BitRate;
                        }
                    }
                } while (frame != null);
            }
